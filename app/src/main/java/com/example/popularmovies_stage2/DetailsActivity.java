...
import com.example.popularmovies_stage2.database.MovieDatabase;
...
public class DetailsActivity extends AppCompatActivity  implements TrailerAdapter.ListItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (movieItem == null) {
            closeOnError(getString(R.string.error_NoMoviewData));
            return;
        }
    ...
    public class ReviewsQueryTask extends AsyncTask<SearchURLs, Void, ResultsStrings> {
        ...
        protected ResultsStrings doInBackground(SearchURLs... params) {
            ...
            try {
                ...
                reviewList = JsonUtils.ReviewsJson(reviewResults);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(ResultsStrings results) {
            ...
            if (searchResults != null && !searchResults.equals("")) {
                reviewList = JsonUtils.ReviewsJson(searchResults);
                populateDetails();
            }
        }
    }
